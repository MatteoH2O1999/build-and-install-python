...
core_1.default.info(`Requested Python version: ${core_1.default.getInput('python-version')}`);
core_1.default.info(`Requested architecture: ${core_1.default.getInput('architecture')}`);
core_1.default.info(`Requested cache: ${core_1.default.getInput('cache-build')}`);
core_1.default.info(`Requested build behavior: ${core_1.default.getInput('allow-build')}`);
