...
const tests: ExpectedTestResult[] = [
  {
    ...
    inputVersion: {
      freethreaded: false,
      type: PythonType.CPython,
      version: '>=2.7.0 <2.8.0-0'
    }
  },
  {
    expectedArchitecture: 'x64',
...
const failingTests: PythonVersion[] = [
  {freethreaded: false, type: PythonType.PyPy, version: '3.x.x'},
  {freethreaded: false, type: PythonType.PyPy, version: '2.x.x'}
];

export {failingTests};

const nullTests: PythonVersion[] = [
  {freethreaded: false, type: PythonType.CPython, version: '3.0.2'},
  {freethreaded: false, type: PythonType.CPython, version: '3.6.20'},
  {freethreaded: false, type: PythonType.CPython, version: '3.5.15'}
];
